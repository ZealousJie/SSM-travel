...
<div class="container">
  <ol class="breadcrumb">
    <li>你的位置：</li>
    <li><a href="#">首页</a></li>
    <li class="active">关于热门</li>
  </ol>
  <div class="col-md-12">
    <div class="list-title">关于热门</div>
    	<div class="col-md-8">
        <div class="jd-summary">
          <div class="row">
             <div class="col-md-3 img"><img src="<%=basePath%>/img/no1.png" class="img-responsive"></div>
             <div class="col-md-9 content">
                <h4><em>热门游名：${hotOrder[0].name}</em></h4>
                <h4><em>单票价格：${hotOrder[0].price}</em></h4>
                <h4><em>游玩人数：${hotOrder[0].num}</em></h4>
                 <a href="${pageContext.request.contextPath}/hotel?oid=${hotOrder[0].id}" style="font-size: 30px">查看详情</a>
             </div>
             <div class="clearfix"></div>
          </div>
        </div>
            <div class="jd-summary">
                <div class="row">
                    <div class="col-md-3 img"><img src="<%=basePath%>/img/no2.png" class="img-responsive"></div>
                    <div class="col-md-9 content">
                        <h4><em>热门游名：${hotOrder[1].name}</em></h4>
                        <h4><em>单票价格：${hotOrder[1].price}</em></h4>
                        <h4><em>游玩人数：${hotOrder[1].num}</em></h4>
                        <a href="${pageContext.request.contextPath}/hotel?oid=${hotOrder[1].id}" style="font-size: 30px">查看详情</a>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
            <div class="jd-summary">
                <div class="row">
                    <div class="col-md-3 img"><img src="<%=basePath%>/img/no3.png" class="img-responsive"></div>
                    <div class="col-md-9 content">
                        <h4><em>热门游名：${hotOrder[2].name}</em></h4>
                        <h4><em>单票价格：${hotOrder[2].price}</em></h4>
                        <h4><em>游玩人数：${hotOrder[2].num}</em></h4>
                        <a href="${pageContext.request.contextPath}/hotel?oid=${hotOrder[2].id}" style="font-size: 30px">查看详情</a>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
            <div class="jd-summary">
                <div class="row">
                    <div class="col-md-3 img"><img src="<%=basePath%>/img/no4.png" class="img-responsive"></div>
                    <div class="col-md-9 content">
                        <h4><em>热门游名：${hotOrder[3].name}</em></h4>
                        <h4><em>单票价格：${hotOrder[3].price}</em></h4>
                        <h4><em>游玩人数：${hotOrder[3].num}</em></h4>
                        <a href="${pageContext.request.contextPath}/hotel?oid=${hotOrder[3].id}" style="font-size: 30px">查看详情</a>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
            <div class="jd-summary">
                <div class="row">
                    <div class="col-md-3 img"><img src="<%=basePath%>/img/no5.png" class="img-responsive"></div>
                    <div class="col-md-9 content">
                        <h4><em>热门游名：${hotOrder[4].name}</em></h4>
                        <h4><em>单票价格：${hotOrder[4].price}</em></h4>
                        <h4><em>游玩人数：${hotOrder[4].num}</em></h4>
                        <a href="${pageContext.request.contextPath}/hotel?oid=${hotOrder[4].id}" style="font-size: 30px">查看详情</a>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
