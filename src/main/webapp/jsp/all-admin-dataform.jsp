...
<body class="hold-transition skin-purple sidebar-mini">
                        ...
                        <div class="box">
                            <div class="box-header">
                                ...
                                <div style="width: 100px">
                                    <a href="add.jsp" ><button type="button" class="btn btn-block btn-danger" >新建</button></a>
                                </div>
                            ...
                            <div class="box-body">
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>${role.roledes}</td>
                                        <td>
											<a href="javascript:void(0);" onclick="delRole('${role.id}')" style="width: 100px" class="btn btn-danger">删除</a>
                                            <a href="javascript:void(0);" onclick="updateRole('${role.id}')" style="width: 100px" class="btn btn-danger">修改</a>
										</td>
                                    </tr>
                                    </c:forEach>
                                </table>
    ...
    <script>
        ...
        function updateRole(roleId){
            location.href="${pageContext.request.contextPath}/jsp/update?roleId="+roleId;
        }
        function delRole(roleId){
            if(confirm("你确定要删除吗？")){
                //这里是 / 代替？ 是因为采用了restful的风格
                location.href="${pageContext.request.contextPath}/jsp/remove/"+roleId;
            }
        }
    </script>
</body>
