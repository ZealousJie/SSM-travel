        ...
        <div class="content-wrapper">
            ...
            <!-- 内容头部 /-->
             <div class="tab-content">
                 <form action="${pageContext.request.contextPath}/jsp/Add">
                            <!--label显示的内容-->
                            <div class="tab-pane active" id="tab-label">
                                ...
                                <div class="row data-type">
                                    ...
                                    <div class="col-md-4 data text">
                                        <input type="text" class="form-control" placeholder="角色邮箱"  name="remail">
                                    </div>

                                    <div class="col-md-2 title"> 角色描述</div>
                                  <div class="data text col-md-10">
                                        <input type="text" class="form-control" placeholder="角色描述"  name="roledes">
                                    </div>
</div>
                                <div class="col-md-2 col-md-offset-5"><input type="submit" class="btn btn-block btn-danger" value="添加"  >
                                                                        <input type="text" value="${msg}" id="msgg" style="display: none"></div>
                      </div>
                 </form>
