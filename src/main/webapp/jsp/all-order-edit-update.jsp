...
<head>
    ...
    <link rel="stylesheet" href="../ueditor/themes/defaults/ueditor.css">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            ...
                            <input type="text" class="form-control" placeholder="订单编号" value="${order.id}" id="oid" readonly="readonly">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right" id="odate" value="${order.odate}">
                            </div>
                        </div>
                        <div class="col-md-2 title">目的城市</div>
                        <div class="col-md-4 data">
<%--                            <select class="form-control select2" style="width: 100%;" >--%>
<%--                                <option value="${order.travel.tname}" selected="selected" id="tname"></option>--%>
...
<%--                            </select>--%>
                                <input type="text" class="form-control" placeholder="目的城市" value="${order.travel.tname}" id="tname">
                        </div>
                        <div class="col-md-2 title">游行概称</div>
                        <div class="col-md-4 data">

                            <input type="text" class="form-control" placeholder="路线概称" value="${order.name}" id="name">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right" id="ttime" value="${order.ttime}" >
                            </div>
                        </div>
                        <div class="col-md-2 title">出游人数</div>
                        <div class="col-md-4 data">

                            <input type="text" class="form-control" placeholder="出游人数" value="${order.pnum}" id="pnum">
                        </div>

                        <div class="col-md-2 title" style="height: 400px">景点详情</div>
                        <div class="col-md-10 data" style="height: 400px">
                            <textarea id="tdescription"  style="height: 300px;">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data text">
                            ￥<input id="price" value="${order.price}" type="text" placeholder="金额">
                        </div>
                    </div>
                ...
                <div class="box-tools text-center">
                    <button type="button" class="btn bg-maroon" onclick="a1()">保存</button>
        ...
        <footer class="main-footer">
            ...
            <input value="${order.travelId}" id="travelId" style="display: none">
    ...
    <script>
        var ue = UE.getEditor("tdescription");
        ue.ready(function (){
        ...
        function a1(){
            let order =  {'id':$("#oid").val(),'odate':$("#odate").val(),'price':$("#price").val(),
                'ttime':$("#ttime").val(),'name':$("#name").val(),'pnum':$("#pnum").val(),
                'tname':$("#tname").val(),'tdescription':ue.getContentTxt(),'travelId':$("#travelId").val()};

            $.ajax({
                url:"${pageContext.request.contextPath}/jsp/updateDesc",
                type:"post",
                dataType: "text",
                data: order,
                success:function () {
                    alert("编辑成功！");
                    window.location.href="${pageContext.request.contextPath}/jsp/order";
                }
            });
        }
