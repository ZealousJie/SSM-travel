        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="${pageContext.request.contextPath}/jsp/userAll">用户管理</a></li>
            ...
            <form action="${pageContext.request.contextPath}/jsp/userAdd" method="post" enctype="multipart/form-data">
                <!--订单信息-->
                <div class="panel panel-default">
                    <div class="panel-heading">手动注册用户</div>
                    <div class="row data-type">


                        <div class="col-md-2 title">用户邮箱</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="用户邮箱" name="email">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="用户密码" name="password">
                        </div>

                        <div class="col-md-2 title">用户手机</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="用户手机号" name="phone">
                        </div>
                        <div class="col-md-2 title">用户角色</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="1234" name="rid">
                        </div>
                        <div class="col-md-2 title">上传照片</div>
                        <div class="col-md-4 data">
                            <input type="file" name="myfile" value="请选择图片">
                        </div>
                ...
                <div class="box-tools text-center">
                    <input type="submit" value="确定" class="btn btn-block btn-danger">
