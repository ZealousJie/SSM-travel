        ...
        <div class="content-wrapper">
            ...
            <!-- 内容头部 /-->
             <div class="tab-content">
                 <form action="${pageContext.request.contextPath}/jsp/saveUp" method="post">
                            <!--label显示的内容-->
                            <div class="tab-pane active" id="tab-label">

                                <div class="row data-type">
                                    <div class="col-md-2 title"> 角色序号</div>
                                    <div class="col-md-4 data text">
                                        <input type="text" class="form-control" placeholder="角色序号"
                                               name="id" value="${role.id}" readonly="readonly">
                                    </div>
                                    <div class="col-md-2 title"> 角色姓名</div>
                                    <div class="col-md-4 data text">
                                        <input type="text" class="form-control" placeholder="角色姓名"
                                        name="rolename" value="${role.rolename}">
                                    </div>

                                    <div class="col-md-2 title">角色邮箱</div>
                                    <div class="col-md-4 data text">
                                        <input type="text" class="form-control" placeholder="角色邮箱"  name="remail" value="${role.remail}">
                                    </div>

                                    <div class="col-md-2 title"> 角色描述</div>
                                  <div class="col-md-4 data text">
                                        <input type="text" class="form-control" placeholder="角色描述"  name="roledes" value="${role.roledes}">
                                    </div>
</div>
